...
<div class="l-container">
  ...
  <main>
    <div class="p-sent">
      ...
      <p class="p-sent__text" data-sal="slide-up">弊社の資料に興味を持って頂きありがとうございます。<br>資料は下記のボタン、またはメールよりダウンロードください。</p>
      <?php get_template_part('template-parts/block-sent-menu'); ?>
      <div class="p-sent__download text-center my-5" data-sal="slide-up">
        <button class="btn btn-custom-gradient text-white -large js-download-button rounded-pill">
      ...
      <div class="p-sent__back text-center mt-5" data-sal="slide-up">
